...
class Task extends \yii\db\ActiveRecord
{
    ...
    public function beforeDelete()
    {
        if ($this->owner_id != Yii::$app->user->id) {
            throw new AccessDeniedException("You can not delete this task. You are not owner of this task!");
        }
        if ($this->worker_id) {
            throw new AccessDeniedException("You can not delete this task. It has worker!");
        }
